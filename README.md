...
### `cd active_person_react && npm start`
...
Runs the app in the development mode. for Expresss server<br />
...
### `cd active_person_react && npm run build`
...
### `cd active_person_react && npm run eject`
